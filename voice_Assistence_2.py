...
def sendEmail(to, content):
    ...
    server.starttls()
    #Enter the email
    server.login('sahilrai9815@gamil.com', 'codesownway0707')
    server.sendmail('jasonhutnts0707@gamil.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
          ...
          if 'wikipedia' in query:
              ...
              codepath = "C:\\Users\\sahil\\OneDrive\\Desktop\\Python Programs\\server.py"
              ...
              webbrowser.open(f"https://www.google.com/search?q={search_query}+in+hindi")

          elif 'search in gujarati for' in query:
              search_query = query.replace('search in gujarati for', '')
              webbrowser.open(f"https://www.google.com/search?q={search_query}+in+gujarati")

          elif 'send gmail to' in query:
            try:
